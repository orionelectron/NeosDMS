          ...
          >
            ...
            <div className="space-y-2">
              ...
              {showCost && (
                <p className="text-xs text-muted-foreground">
                  {mode === "opening"
                    ? "Unit cost is the per-unit cost used to value stock — pre-filled from the item's standard cost when available. It becomes the moving-average cost shown as Avg cost in Stock balances."
